...
## 4. CLARIFICATION OF TESTING AND QA RIGHTS
The Licensor may, from time to time, invite external individuals or entities to participate in quality assurance (QA) activities, beta testing, feedback collection, or debugging.
* **No Transfer of Rights:** Participation in such testing, feedback, or QA processes does **NOT** grant, convey, or transfer any copyright ownership, intellectual property rights, code modification rights, or proprietary stakes of any kind in the Software to the tester or reviewer.
* **Sole Property of Licensor:** All feedback, bug reports, suggestions, or ideas provided by testers are the exclusive property of the Licensor, who may incorporate them into the Software without any obligation of compensation, royalty, or attribution to the tester.

## 5. PROPRIETARY RESTRICTIONS
This Software is licensed under a strict closed-source, proprietary model. Licensees are granted no rights except as explicitly permitted by a separate written agreement with the Copyright Holder.
* **No Distribution:** You may not distribute, lease, rent, sell, sub-license, publish, assign, or otherwise transfer the Software or any portion thereof to any third party.
* **No Modification or Derivative Works:** You are strictly prohibited from copying, modifying, altering, translating, adapting, reverse engineering, decompiling, disassembling, or creating derivative works based on the Software.
* **No Public Code Repositories:** You may not host the Software, modified or unmodified, on public repositories (e.g., public GitHub, GitLab, Bitbucket) or file-sharing platforms.
...
## 8. GOVERNING LAW
This Agreement shall be governed by, construed, and enforced in accordance with the laws of the jurisdiction of the Copyright Holder's residence, without regard to conflict of law principles.

---
**For inquiries, licensing requests, or written permissions, contact Tanay Kumar Singh directly.**
